...
def resampling(source_file, target_file, scale):
    ...
    total = band_count + 1
    respledata = np.zeros([band_count, cols, rows])
    ...
    del dataset
    del target
    io.imsave(target_file, respledata)
    return respledata
...
if __name__ == "__main__":
    dataset_dir = '../traindata/net2_s2tol8'
    ...
    # l8path1 = "../image/AHB/L8_20210425_90m.tif"
    # s2path1 = "../image/AHB/S2_20210414_90m.tif"
    ...
    # l8path1 = "../image/EWZ/20200524/L8_20200524_90m_p.tif"
    # s2path1 = "../image/EWZ/20200524/S2_20200519_90m.tif"
    ...
    cropsize = 32# 256 # 64 #16 # 64 # 240  # 32 # 16
    crop(raw_L8, raw_S2, cropsize, cropsize, prefix='net2', save_dir=dataset_dir)
